 ...
 * 并行计算
 */
public class Test8 extends RecursiveTask<Integer> {
    ...
    public Test8(long[] array, int low, int high) {
        this.array = array;
        this.low = low;
        this.high = high;
    }
    ...
    protected Integer compute() {
        ...
        if (high - low <= THRESHOLD) {
            ...
            // 1. 一个大任务分割成两个子任务
            int mid = (low + high) >>> 1;
            Test8 left = new Test8(array, low, mid);
            Test8 right = new Test8(array, mid + 1, high);
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        // 1. 创建任务
        Test8 sumTask = new Test8(array, 0, array.length - 1);
