...
public class MA_CPABE_CSC_CPA implements Ident {
    ...
    public void decrypt() {
        ...
        try {
            LangPolicy.decrypt(pk, sk, ciphertext, attributes_A, attributes_C, thresholds, attributes_Us, fileBasePath + Message_Ciphertext_File, fileBasePath + Message_Decrypt_File);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
